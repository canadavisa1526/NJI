      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div>
          <div className="bg-gradient-to-br from-[#13294E] to-[#193966] rounded-t-xl p-5">
            ...
            <p className="text-[#AFC1DB]">
              Estimated Monthly Expenses ({country.costOfLiving.currency})
            </p>
          </div>

          <div className="bg-card border-x border-b border-border rounded-b-xl p-6 shadow-md dark:shadow-gray-800">
            <ul className="space-y-4">
              <li className="flex justify-between items-center pb-2 border-b border-border">
                <span className="text-muted-foreground">Accommodation</span>
                <span className="font-medium text-[#13294E] dark:text-white">
              ...
              <li className="flex justify-between items-center pb-2 border-b border-border">
                ...
                <span className="font-medium text-[#13294E] dark:text-white">
                  {country.costOfLiving.miscellaneous}
                </span>
              </li>

              <li className="flex justify-between items-center pt-2">
                <span className="font-semibold text-[#13294E] dark:text-white">
                  Total (Monthly)
                </span>
                <span className="font-bold text-[#FAA71A]">
                  {country.costOfLiving.total}
                </span>
              </li>
            </ul>

            <div className="mt-6 bg-[#AFC1DB]/10 dark:bg-[#AFC1DB]/5 border border-[#AFC1DB]/20 dark:border-[#AFC1DB]/10 rounded-lg p-4">
        ...
        <div>
          <div className="bg-gradient-to-br from-[#FAA71A] to-[#f39c00] rounded-t-xl p-5">
            ...
            <p className="text-[#13294E]/80">
              Estimated Yearly Expenses ({country.costOfStudy.currency})
            </p>
          </div>
          ...
          <div className="bg-card border-x border-b border-border rounded-b-xl p-6 shadow-md dark:shadow-gray-800">
            <ul className="space-y-4">
              <li className="flex justify-between items-center pb-2 border-b border-border">
                <span className="text-muted-foreground">Accommodation</span>
                <span className="font-medium text-[#13294E] dark:text-white">
                  {country.costOfStudy.accommodation}
                </span>
              </li>
              ...
              <li className="flex justify-between items-center pb-2 border-b border-border">
                <span className="text-muted-foreground">Transportation</span>
                <span className="font-medium text-[#13294E] dark:text-white">
                  {country.costOfStudy.transportation}
                </span>
              </li>
              ...
              <li className="flex justify-between items-center pb-2 border-b border-border">
                <span className="text-muted-foreground">Miscellaneous</span>
                <span className="font-medium text-[#13294E] dark:text-white">
                  {country.costOfStudy.miscellaneous}
                </span>
              </li>
