    ...
    <section className="py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        <div className="order-2 lg:order-1">
          ...
          <div className="mt-8">
            <h3 className="text-xl font-semibold text-[#13294E] dark:text-white mb-4">Key Points</h3>
        ...
        <div className="order-1 lg:order-2">
          <div className="relative h-80 md:h-96 lg:h-[500px] rounded-xl overflow-hidden shadow-lg dark:shadow-gray-800 transform transition-transform duration-500 hover:scale-[1.02]">
            <Image
