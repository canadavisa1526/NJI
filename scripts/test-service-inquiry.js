// This script tests the Google Sheets integration for service inquiries
// Run it with: node scripts/test-service-inquiry.js
...
async function appendTestServiceInquiry() {
  try {
    console.log("Testing Google Sheets integration for service inquiries...");
    ...
    const testData = [
      [
        ...
        "+1234567890",
        "This is a test message for a service inquiry.",
    ...
    console.log("Attempting to append test service inquiry data to Google Sheets...");
    ...
    console.log("✅ Success! Test service inquiry data appended to Google Sheets.");
