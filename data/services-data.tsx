...
export const testimonials = [
  {
    ...
    quote:
      "After multiple rejections, I was losing hope of visiting my sister in Sydney. NJI's team analyzed my case, fixed the issues in my application, and I got my visitor visa approved in just 3 weeks!",
    rating: 5,
  },
  {
    id: 2,
    ...
    quote:
      "The PR process seemed overwhelming until I found NJI. Their step-by-step guidance through Express Entry made everything manageable. Today, I'm a proud Canadian PR!",
    rating: 5,
  },
  {
    id: 3,
    ...
    quote:
      "From a 6.5 to 8.0 in IELTS - that's what NJI's coaching helped me achieve! Their techniques and practice sessions were exactly what I needed for my UK university application.",
    rating: 5,
  },
  {
    id: 4,
    ...
    quote:
      "When my tech company wanted to transfer me to their Berlin office, I had no idea about German work permits. NJI handled everything from documentation to submission, saving me countless hours.",
    rating: 4,
  },
  {
    id: 5,
    name: "Neha Kapoor",
    service: "dependent-visa",
    country: "USA",
    image:
      "https://images.pexels.com/photos/1181695/pexels-photo-1181695.jpeg?auto=compress&cs=tinysrgb&w=600",
    quote:
      "Joining my husband in the US seemed like a distant dream with all the complexities. NJI made it happen with their meticulous approach to dependent visa applications!",
    rating: 5,
  },
  {
    id: 6,
    ...
    quote:
      "The education loan and forex services from NJI were beyond helpful. They secured me a loan with minimal interest and their forex rates saved me thousands compared to banks!",
    rating: 5,
  },
  {
    id: 7,
    ...
    quote:
      "Their insurance recommendation literally saved me thousands of dollars when I needed emergency dental work in Toronto. The comprehensive policy they suggested covered everything!",
    rating: 5,
  },
];
