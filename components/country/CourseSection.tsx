        ...
        {country.topCourses.map((course, index) => (
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-xl font-semibold text-[#13294E]">{course.name}</h3>
              <span className="bg-[#AFC1DB]/30 text-[#13294E] py-1 px-3 rounded-full text-sm">
                {course.level}
              </span>
            </div>
            ...
            <div className="flex flex-wrap gap-4 mb-4">
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-600">{course.averageFee}</span>
              </div>
            </div>
            
            <p className="text-gray-700 mb-4">{course.description}</p>
            
            <button className="mt-2 text-[#13294E] hover:text-[#FAA71A] font-medium transition-colors duration-200">
              Learn More →
            </button>
          </div>
        ))}
